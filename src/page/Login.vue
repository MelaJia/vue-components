<template>
      ...
      <div class="bigPicture">
          ...
          <div class="bd">
            <ul style="position: relative;">
                    <li style="height: 740px; position: absolute; left: 0px; top: 0px; ">
                        <a href="https://www.iqianbang.com/Activity-getnewers?userfrom=sem%7cbaidu%7cpc%7c89171#?userfrom=sem%7cbaidu%7cpc%7c89171" target="_blank" class="pic"></a>
                    </li>
            </ul>
          </div>
        ...
        <!-- index_focus end -->
            <div class="wrapper">
                ...
                <input type="hidden" name="__hash__" value="ddb92acedd9bd8372428976866a2bf7d_d2469a6c836a041ad5df5fa5e4b42a9e"></form>
            </div>
      </div>
            ...
            <div class="dataGroup clearfix">
              ...
              <div class="data">
                ...
                <!--<h3><big>122亿</big>795万4196元</h3>-->
                            <h3 id="pf_money"><big>132亿</big>9241万6998.09元</h3>
              </div>
            </div>
            <div class="dataGroup dataGroup2 clearfix">
              ...
              <div class="data">
                ...
                <!--<h3><big>483万</big>5981人</h3>-->
                            <h3 id="pf_user"><big>47万</big>8071人</h3>
              </div>
            </div>
    ...
    <div class="activeFotter" style="background: rgb(159, 159, 159) ">
            <p class="daBG"><img src="@/assets/img/login/iconJY.png" />深圳钜信科技有限公司</p>
            <p>深圳市龙华新区</p>
