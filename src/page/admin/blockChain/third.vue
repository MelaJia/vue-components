      ...
      <el-col :span="20" :offset="2">
        <el-form ref="form" :model="content" label-width="100px">
          ...
          <el-form-item>
            ...
            <div>
              <el-button type="primary" @click="post('')">合同新增</el-button>
              <el-button type="default" @click="post('contract')">合同查询</el-button>
              <el-button type="default" @click="post('contractQueryPermissionsAllocation')">合同查看权限分配</el-button>
            </div>
          </el-form-item>
...
var tmpl = {
  ...
  contractQueryPermissionsAllocation: {
    key: 'contractQueryPermission',
    method: 'contractQueryPermission',
    content: {}
  },
  contract: {
    key: 'contractNo',
