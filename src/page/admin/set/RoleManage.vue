  ...
  <div class="main">
    ...
    <div class="body">
      <el-card class="box-card text-align-center">
        <role-table :data-loading="loading" :data-table="tableData5" @refresh="handleRefresh"></role-table>
        <el-pagination
...
<script>
import RoleTable from '@/components/Admin/set/RoleTable'
import Search from '@/components/Admin/set/RoleSearch'
import Table from '@/mixins/suplier/Ar/Table'
export default {
  name: 'rolesearch', // 订单查询
  mixins: [Table],
  data () {
    return {
      loading: false,
