  ...
  <div class="main">
    ...
    <div class="body">
      <el-card class="box-card text-align-center">
        <wait-table :data-loading="loading" :data-table="tableData5" @refresh="handleRefresh"></wait-table>
        <el-pagination
...
<script>
import WaitTable from '@/components/suplier/arApi/waitRepay/WaitrepayTable'
import Search from '@/components/suplier/arApi/waitRepay/WaitrepaySearch'
...
export default {
  ...
  data () {
    return {
      loading: false,
      postUrl: '/multiArOnRepaymentManager/getOnRepaymentArListTable.do',
      dataStr: 'data',
      totalStr: 'recordsTotal'
    }
  },
  components: {
    'wait-table': WaitTable,
    'search': Search
  },
  mounted () {
