...
<script>
import MyarrearTable from '@/components/suplier/auxiliarySelect/MyarrearTable'
import Search from '@/components/suplier/auxiliarySelect/MyarrearSearch'
