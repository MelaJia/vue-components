...
import ArTable from '@/components/suplier/loan/creditLoan/loan/LoanList'
import Search from '@/components/suplier/loan/creditLoan/loan/LoanSearch'
...
export default {
  ...
  mounted () {
    this.param.status = this.$route.query.checkedStatus ? this.$route.query.checkedStatus : '' // 判断是否是有参数传递
