  ...
  <div class="ar-table" ref="resizeContext">
    ...
    <section>
      <el-table ref="table" :data="dataTable" v-loading.fullscreen="dataLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
        ...
        <el-table-column align="center" label="结报申请付款日期" prop="dueDate" width="100" :formatter="dateFormat">
        </el-table-column>
...
export default {
  ...
  components: {
    'dialog-mysubmit': () =>
      import(/* webpackChunkName: 'Dialog' */ '@/components/Admin/auxiliarySelect/DialogMysubmit')
  },
  data () {
    return {
