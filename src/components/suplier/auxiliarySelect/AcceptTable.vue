  ...
  <div class="ar-table">
    ...
    <section>
      <el-table ref="table" :data="dataTable" v-loading="dataLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
        ...
        <el-table-column type="expand" fixed>
          <template slot-scope="props">
            <el-table :data="props.row.tableData" border style="width: 100%" :show-header="false" :row-class-name="getPendedColor">
              ...
              <el-table-column align="center" prop="grnNumbe" :width="widthArr.grnNumbe">
              </el-table-column>
        ...
        <el-table-column align="center" label="约定交货日期" prop="deliveryDate" width="150" :formatter="dateFormat">
        </el-table-column>
...
export default {
  ...
  components: {
    'dialog-accept': () =>
      import(/* webpackChunkName: 'Dialog' */ '@/components/suplier/auxiliarySelect/DialogAccept')
  },
  data () {
    return {
