  ...
  <div class="ar-table" ref="resizeContext">
    ...
    <section>
      <el-table ref="table" :data="dataTable" v-loading.fullscreen="dataLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
        ...
        <el-table-column align="center" label="对账单号" fixed sortable prop="statementNo" width="150">
        </el-table-column>
        <el-table-column align="center" label="进货验收单号" prop="grnNumber" width="">
        </el-table-column>
...
export default {
  ...
  components: {
    'dialog-mybill': () =>
      import(/* webpackChunkName: 'Dialog' */ '@/components/suplier/auxiliarySelect/DialogMybill')
  },
  data () {
    return {
