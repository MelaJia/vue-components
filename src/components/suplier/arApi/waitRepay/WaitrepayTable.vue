      ...
      <el-table ref="table" :data="dataTable" v-loading.fullscreen="dataLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
        ...
        <el-table-column align="center" label="操作" header-align="center" width='120' fixed="right" :resizable="false">
          <template slot-scope="scope">
            ...
            <el-button size="mini" type="text" @click="repayPlan(scope.$index, scope.row)">还款计划</el-button>
          </template>
        </el-table-column>
      </el-table>
    </section>
...
export default {
  ...
  components: {
    ...
    'dialog-repay': () =>
      import(/* webpackChunkName: 'Dialog' */ '@/components/suplier/arApi/waitRepay/DialogRepay')
  },
  data () {
    return {
