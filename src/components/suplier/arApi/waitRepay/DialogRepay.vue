<template>
  <el-dialog :custom-class="'dia-class style-dia-repay report'" :visible.sync="visibleP" :before-close="handleClose" center="">
    <section>
      <article>
        <header class="repay-header headerTitle">还款计划表</header>
      ...
      <article>
        <header class="repay-header headerTitle">还款明细</header>
        <div class="repay-detail-conten">
          <el-table
            ...
            <el-table-column
              ...
              header-align="center"
              prop="interest"
              :formatter="regexNum" min-width="80"
              label="利息（元）">
            </el-table-column>
            <el-table-column
              align="right"
            ...
            <el-table-column
              align="center"
              header-align="center"
              prop="overdueDays" min-width="80"
              label="逾期天数（天）">
            </el-table-column>
            <el-table-column
              align="center"
              header-align="center"
              prop="prepaymentFee" min-width="100"
              label="提前还款手续费">
            </el-table-column>
            <el-table-column
              align="center"
              header-align="center"
              prop="periodPaidAmt" :formatter="regexNum" min-width="123"
              label="已还金额（元）">
            </el-table-column>
            <el-table-column
            align="center"
              prop="periodSettledDate"
              label="结清日期"
              :formatter="dateFormat"
              width="100">
            </el-table-column>
