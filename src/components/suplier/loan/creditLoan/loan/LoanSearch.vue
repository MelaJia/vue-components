<template>
  <el-form :inline="true" :model="formInline" ref="formInline" class="demo-form-inline loan-search-style" size="small" label-width="100px">
    <el-row>
      <el-col :span="7">
      ...
      <el-col :span="7" :offset="3" prop="status">
