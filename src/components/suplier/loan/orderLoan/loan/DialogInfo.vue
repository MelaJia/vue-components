    ...
    >
      ...
      <section class="section">
        <ul class="height-auto">
          <el-table :data="detailsP.poLoanInfoList" height="150" border style="width: 100%">
            <el-table-column prop="corpCode" label="法人代碼" width="160"></el-table-column>
            <el-table-column prop="corpName" label="法人单位" width="150"></el-table-column>
            <el-table-column label="订单号">
              <template slot-scope="scope">
                <span
                  class="po-number-style"
                  v-for="(item,idx) in scope.row.poLoanDetailInfoList"
                  :key="idx"
