        ...
        <el-table-column type="expand" fixed>
          <template slot-scope="props">
            <el-table :data="props.row.tableData" border style="width: 100%" :show-header="false" :row-class-name="getColor">
              ...
              <el-table-column align="center" :width="widthArr.currency">
              </el-table-column>
              <el-table-column align="center" :width="widthArr.repaymentType">
              </el-table-column>
              <el-table-column align="right" prop="loanAmt" :width="widthArr.loanAmt" :formatter="regexNum">
              </el-table-column>
              ...
              <el-table-column align="center" label-align="center" width="150">
                <template slot-scope="scope">
                  <el-button size="mini" v-if="scope.row.isShowRepayButton == '0' || ((scope.row.actualRepayAmt == undefined || scope.row.actualRepayAmt == null) && (scope.row.actualRepayDate == undefined || scope.row.actualRepayDate == null))" type="primary" @click="repayMent(scope.$index, scope.row)">还款</el-button>
                </template>
              </el-table-column>
            </el-table>
          </template>
