  ...
  <div class="ar-table" ref="resizeContext">
    ...
    <section>
      <el-table ref="table" :data="dataTable" v-loading.fullscreen="dataLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
        ...
        <el-table-column align="right" header-align="center" label="实际付款金额" prop="rcvAmtOrigin" width="150" :formatter="regexNum">
        </el-table-column>
...
export default {
  ...
  components: {
    'dialog-mypayer': () =>
      import(/* webpackChunkName: 'Dialog' */ '@/components/Fund/auxiliarySelect/DialogMypayer')
  },
  data () {
    return {
