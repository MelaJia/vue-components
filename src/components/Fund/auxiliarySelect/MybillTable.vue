  ...
  <div class="ar-table">
    ...
    <section>
      <el-table ref="table" :data="dataTable" v-loading.fullscreen="dataLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
        ...
        <el-table-column align="center" label="录入日期" prop="entryDate" minwidth="100" :formatter="dateFormat">
        </el-table-column>
...
export default {
  ...
  components: {
    'dialog-mybill': () =>
      import(/* webpackChunkName: 'Dialog' */ '@/components/Fund/auxiliarySelect/DialogMybill')
  },
  data () {
    return {
