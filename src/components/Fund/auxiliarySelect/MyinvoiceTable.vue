  ...
  <div class="ar-table">
    ...
    <section>
      <el-table ref="table" :data="dataTable" v-loading.fullscreen="dataLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
        ...
        <el-table-column align="center" header-align="center" label="币别" prop="currencyName" min-width="100">
        </el-table-column>
...
export default {
  ...
  components: {
    'dialog-myinvoice': () =>
      import(/* webpackChunkName: 'Dialog' */ '@/components/Fund/auxiliarySelect/DialogMyinvoice')
  },
  data () {
    return {
