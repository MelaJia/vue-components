  ...
  <div class="ar-table" ref="resizeContext">
    ...
    <section>
      <el-table id="tb" :data="dataTable" v-loading.fullscreen="dataLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
        ...
        <el-table-column align="right" header-align="center" label="贴现放款金额" prop="billBookAmt" width="150" :formatter="regexNum">
        </el-table-column>
...
export default {
  ...
  components: {
    ...
    'dialog-repay': () =>
      import(/* webpackChunkName: 'Dialog' */ '@/components/Fund/Work/Loaned/DialogRepay')
  },
  data () {
    return {
